    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.Authority = "https://securetoken.google.com/heartbeet-334400";
                options.TokenValidationParameters = new TokenValidationParameters
                {
                    ValidateLifetime = true,
                    ValidateAudience = true,
                    ValidateIssuer = true,
                    ValidAudience = "heartbeet-334400",
                    ValidIssuer = "https://securetoken.google.com/heartbeet-334400"
                };
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HeartBeet", Version = "v1" });
            });
        }
